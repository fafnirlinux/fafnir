...
"linux-thread-multi-5.18.10-arch1-1" or
	die "Errno architecture (linux-thread-multi-5.18.10-arch1-1) does not match executable architecture ($Config{'archname'}-$Config{'osvers'})";
